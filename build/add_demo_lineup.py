...
LINEUP = [
    ...
    {"dev": "Timothy Short", "plan": "wsapi admin changes for Restock, plus the updates to the Restock Dashboard.",
     "kw": r"restock"},
    {"dev": "Kennedy Kirk", "plan": "Merge.dev (QuickBooks) accounting integration — doc going to the review chat in the morning. Plus the trial user flow, end to end.",
     "kw": r"merge\.?dev|pricingimport|invoiceimport|quickbooks|chart of accounts"},
    {"dev": "Nathan van Wingerden", "plan": "Space Planning, and the Orders screen with server-side filtering.",
